...
страницы. Происходит это из-за доставшегося нам в наследство из эпохи «Веб 1.0» DOM API. API позволяют прибавлять данные к содержимому, которое в настоящий 
...
Атрибут `defer`, как взорвавшаяся на фабрике по производству шерсти бомба, 
...
`2.js`, тогда ваша страница покроется ошибками, как при попадании гранаты в…  
